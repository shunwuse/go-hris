...
func (_c *UserRoleCreate) SetUserID(v uint) *UserRoleCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetRoleID sets the "role_id" field.
func (_c *UserRoleCreate) SetRoleID(v uint) *UserRoleCreate {
	_c.mutation.SetRoleID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *UserRoleCreate) SetID(v uint) *UserRoleCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *UserRoleCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`entgen: missing required field "UserRole.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`entgen: missing required field "UserRole.updated_at"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`entgen: missing required field "UserRole.user_id"`)}
	}
	...
	if _, ok := _c.mutation.RoleID(); !ok {
		return &ValidationError{Name: "role_id", err: errors.New(`entgen: missing required field "UserRole.role_id"`)}
	}
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := userrole.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`entgen: validator failed for field "UserRole.id": %w`, err)}
		}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`entgen: missing required edge "UserRole.user"`)}
	}
	if len(_c.mutation.RoleIDs()) == 0 {
		return &ValidationError{Name: "role", err: errors.New(`entgen: missing required edge "UserRole.role"`)}
	}
	return nil
}
...
func (_c *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userrole.Table, sqlgraph.NewFieldSpec(userrole.FieldID, field.TypeUint))
	)
