...
func (_c *RefreshTokenCreate) SetDeletedAt(v time.Time) *RefreshTokenCreate {
	_c.mutation.SetDeletedAt(v)
	return _c
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (_c *RefreshTokenCreate) SetNillableDeletedAt(v *time.Time) *RefreshTokenCreate {
	if v != nil {
		_c.SetDeletedAt(*v)
	}
	return _c
...
func (_c *RefreshTokenCreate) SetUserID(v uint) *RefreshTokenCreate {
...
func (_c *RefreshTokenCreate) SetID(v uint) *RefreshTokenCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetOwnerID sets the "owner" edge to the User entity by ID.
func (_c *RefreshTokenCreate) SetOwnerID(id uint) *RefreshTokenCreate {
...
func (_c *RefreshTokenCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`entgen: missing required field "RefreshToken.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`entgen: missing required field "RefreshToken.updated_at"`)}
	}
	if _, ok := _c.mutation.TokenHash(); !ok {
		return &ValidationError{Name: "token_hash", err: errors.New(`entgen: missing required field "RefreshToken.token_hash"`)}
	}
	...
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`entgen: missing required field "RefreshToken.user_id"`)}
	}
	...
	if _, ok := _c.mutation.ExpiresAt(); !ok {
		return &ValidationError{Name: "expires_at", err: errors.New(`entgen: missing required field "RefreshToken.expires_at"`)}
	}
	if _, ok := _c.mutation.Revoked(); !ok {
		return &ValidationError{Name: "revoked", err: errors.New(`entgen: missing required field "RefreshToken.revoked"`)}
	}
	if v, ok := _c.mutation.ID(); ok {
		if err := refreshtoken.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`entgen: validator failed for field "RefreshToken.id": %w`, err)}
		}
	}
	if len(_c.mutation.OwnerIDs()) == 0 {
		return &ValidationError{Name: "owner", err: errors.New(`entgen: missing required edge "RefreshToken.owner"`)}
	}
	return nil
}
