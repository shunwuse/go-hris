...
func (_q *RoleQuery) QueryUserRole() *UserRoleQuery {
...
func (_q *RoleQuery) QueryRolePermission() *RolePermissionQuery {
...
func (_q *RoleQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RoleQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *RoleQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RoleQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *RoleQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *RoleQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		withUserRole:       _q.withUserRole.Clone(),
		withRolePermission: _q.withRolePermission.Clone(),
...
func (_q *RoleQuery) WithUserRole(opts ...func(*UserRoleQuery)) *RoleQuery {
	query := (&UserRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withUserRole = query
	return _q
}
...
func (_q *RoleQuery) WithRolePermission(opts ...func(*RolePermissionQuery)) *RoleQuery {
	query := (&RolePermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withRolePermission = query
	return _q
}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withUserRole; query != nil {
		if err := _q.loadUserRole(ctx, query, nodes,
			func(n *Role) { n.Edges.UserRole = []*UserRole{} },
			func(n *Role, e *UserRole) { n.Edges.UserRole = append(n.Edges.UserRole, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRolePermission; query != nil {
		if err := _q.loadRolePermission(ctx, query, nodes,
			func(n *Role) { n.Edges.RolePermission = []*RolePermission{} },
			func(n *Role, e *RolePermission) { n.Edges.RolePermission = append(n.Edges.RolePermission, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RoleQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Role, init func(*Role), assign func(*Role, *User)) error {
	...
	byID := make(map[uint]*Role)
	nids := make(map[uint]map[*Role]struct{})
...
func (_q *RoleQuery) loadUserRole(ctx context.Context, query *UserRoleQuery, nodes []*Role, init func(*Role), assign func(*Role, *UserRole)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Role)
	for i := range nodes {
	...
	query.Where(predicate.UserRole(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.UserRoleColumn), fks...))
	}))
...
func (_q *RoleQuery) loadRolePermission(ctx context.Context, query *RolePermissionQuery, nodes []*Role, init func(*Role), assign func(*Role, *RolePermission)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.RolePermission(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.RolePermissionColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *RoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(role.Table, role.Columns, sqlgraph.NewFieldSpec(role.FieldID, field.TypeUint))
	_spec.From = _q.sql
