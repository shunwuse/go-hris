...
func (_q *RolePermissionQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RolePermissionQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *RolePermissionQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RolePermissionQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *RolePermissionQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *RolePermissionQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *RoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *Role)) error {
	...
	nodeids := make(map[uint][]*RolePermission)
	for i := range nodes {
		fk := nodes[i].RoleID
...
func (_q *RolePermissionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(rolepermission.Table, rolepermission.Columns, sqlgraph.NewFieldSpec(rolepermission.FieldID, field.TypeUint))
	_spec.From = _q.sql
