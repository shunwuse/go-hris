...
func (_u *PermissionUpdate) SetDescription(v constants.Permission) *PermissionUpdate {
	_u.mutation.SetDescription(v)
	return _u
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillableDescription(v *constants.Permission) *PermissionUpdate {
	if v != nil {
		_u.SetDescription(*v)
	}
	return _u
...
func (_u *PermissionUpdate) AddRoleIDs(ids ...uint) *PermissionUpdate {
...
func (_u *PermissionUpdate) AddRolePermissionIDs(ids ...uint) *PermissionUpdate {
	_u.mutation.AddRolePermissionIDs(ids...)
	return _u
}

// AddRolePermission adds the "role_permission" edges to the RolePermission entity.
func (_u *PermissionUpdate) AddRolePermission(v ...*RolePermission) *PermissionUpdate {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) RemoveRoleIDs(ids ...uint) *PermissionUpdate {
...
func (_u *PermissionUpdate) ClearRolePermission() *PermissionUpdate {
...
func (_u *PermissionUpdate) RemoveRolePermissionIDs(ids ...uint) *PermissionUpdate {
	_u.mutation.RemoveRolePermissionIDs(ids...)
	return _u
}

// RemoveRolePermission removes "role_permission" edges to RolePermission entities.
func (_u *PermissionUpdate) RemoveRolePermission(v ...*RolePermission) *PermissionUpdate {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) check() error {
	if v, ok := _u.mutation.Description(); ok {
		if err := permission.DescriptionValidator(string(v)); err != nil {
			return &ValidationError{Name: "description", err: fmt.Errorf(`entgen: validator failed for field "Permission.description": %w`, err)}
		}
	}
	return nil
}
...
func (_u *PermissionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(permission.Table, permission.Columns, sqlgraph.NewFieldSpec(permission.FieldID, field.TypeUint))
...
// SetDescription sets the "description" field.
func (_u *PermissionUpdateOne) SetDescription(v constants.Permission) *PermissionUpdateOne {
	_u.mutation.SetDescription(v)
	return _u
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (_u *PermissionUpdateOne) SetNillableDescription(v *constants.Permission) *PermissionUpdateOne {
	if v != nil {
		_u.SetDescription(*v)
	}
	return _u
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (_u *PermissionUpdateOne) AddRoleIDs(ids ...uint) *PermissionUpdateOne {
	_u.mutation.AddRoleIDs(ids...)
	return _u
}
...
// AddRolePermissionIDs adds the "role_permission" edge to the RolePermission entity by IDs.
func (_u *PermissionUpdateOne) AddRolePermissionIDs(ids ...uint) *PermissionUpdateOne {
	_u.mutation.AddRolePermissionIDs(ids...)
	return _u
}

// AddRolePermission adds the "role_permission" edges to the RolePermission entity.
func (_u *PermissionUpdateOne) AddRolePermission(v ...*RolePermission) *PermissionUpdateOne {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (_u *PermissionUpdateOne) RemoveRoleIDs(ids ...uint) *PermissionUpdateOne {
	_u.mutation.RemoveRoleIDs(ids...)
	return _u
}
...
// ClearRolePermission clears all "role_permission" edges to the RolePermission entity.
func (_u *PermissionUpdateOne) ClearRolePermission() *PermissionUpdateOne {
	_u.mutation.ClearRolePermission()
	return _u
}

// RemoveRolePermissionIDs removes the "role_permission" edge to RolePermission entities by IDs.
func (_u *PermissionUpdateOne) RemoveRolePermissionIDs(ids ...uint) *PermissionUpdateOne {
	_u.mutation.RemoveRolePermissionIDs(ids...)
	return _u
}

// RemoveRolePermission removes "role_permission" edges to RolePermission entities.
func (_u *PermissionUpdateOne) RemoveRolePermission(v ...*RolePermission) *PermissionUpdateOne {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdateOne) sqlSave(ctx context.Context) (_node *Permission, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entgen: missing "Permission.id" for update`)}
	}
