...
func (_q *UserRoleQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *UserRoleQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *UserRoleQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *UserRoleQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *UserRoleQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *UserRoleQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserRoleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserRole, init func(*UserRole), assign func(*UserRole, *User)) error {
	...
	nodeids := make(map[uint][]*UserRole)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userrole.Table, userrole.Columns, sqlgraph.NewFieldSpec(userrole.FieldID, field.TypeUint))
	_spec.From = _q.sql
