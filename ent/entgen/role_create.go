...
func (_c *RoleCreate) AddPermissionIDs(ids ...uint) *RoleCreate {
...
func (_c *RoleCreate) AddUserRoleIDs(ids ...uint) *RoleCreate {
	_c.mutation.AddUserRoleIDs(ids...)
	return _c
}

// AddUserRole adds the "user_role" edges to the UserRole entity.
func (_c *RoleCreate) AddUserRole(v ...*UserRole) *RoleCreate {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *RoleCreate) AddRolePermissionIDs(ids ...uint) *RoleCreate {
	_c.mutation.AddRolePermissionIDs(ids...)
	return _c
}

// AddRolePermission adds the "role_permission" edges to the RolePermission entity.
func (_c *RoleCreate) AddRolePermission(v ...*RolePermission) *RoleCreate {
	ids := make([]uint, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *RoleCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`entgen: missing required field "Role.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`entgen: missing required field "Role.updated_at"`)}
	}
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := role.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`entgen: validator failed for field "Role.id": %w`, err)}
		}
	}
	return nil
}
