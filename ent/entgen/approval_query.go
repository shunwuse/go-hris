...
func (_q *ApprovalQuery) QueryCreator() *UserQuery {
...
func (_q *ApprovalQuery) QueryApprover() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *ApprovalQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *ApprovalQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *ApprovalQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *ApprovalQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *ApprovalQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *ApprovalQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ApprovalQuery) WithCreator(opts ...func(*UserQuery)) *ApprovalQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ApprovalQuery) WithApprover(opts ...func(*UserQuery)) *ApprovalQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(approval.FieldCreatedAt).
...
//
//	client.Approval.Query().
//		Select(approval.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *ApprovalQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Approval, error) {
	...
	if query := _q.withCreator; query != nil {
		if err := _q.loadCreator(ctx, query, nodes, nil,
			func(n *Approval, e *User) { n.Edges.Creator = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withApprover; query != nil {
		if err := _q.loadApprover(ctx, query, nodes, nil,
			func(n *Approval, e *User) { n.Edges.Approver = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ApprovalQuery) loadCreator(ctx context.Context, query *UserQuery, nodes []*Approval, init func(*Approval), assign func(*Approval, *User)) error {
	ids := make([]uint, 0, len(nodes))
	nodeids := make(map[uint][]*Approval)
	for i := range nodes {
...
func (_q *ApprovalQuery) loadApprover(ctx context.Context, query *UserQuery, nodes []*Approval, init func(*Approval), assign func(*Approval, *User)) error {
	ids := make([]uint, 0, len(nodes))
	nodeids := make(map[uint][]*Approval)
	for i := range nodes {
...
func (_q *ApprovalQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(approval.Table, approval.Columns, sqlgraph.NewFieldSpec(approval.FieldID, field.TypeUint))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCreator != nil {
			_spec.Node.AddColumnOnce(approval.FieldCreatorID)
		}
		if _q.withApprover != nil {
			_spec.Node.AddColumnOnce(approval.FieldApproverID)
		}
	}
