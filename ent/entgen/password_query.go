...
func (_q *PasswordQuery) QueryOwner() *UserQuery {
...
func (_q *PasswordQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *PasswordQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *PasswordQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *PasswordQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *PasswordQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *PasswordQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PasswordQuery) WithOwner(opts ...func(*UserQuery)) *PasswordQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *PasswordQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Password, error) {
	...
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *Password, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PasswordQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Password, init func(*Password), assign func(*Password, *User)) error {
	ids := make([]uint, 0, len(nodes))
	nodeids := make(map[uint][]*Password)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *PasswordQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(password.Table, password.Columns, sqlgraph.NewFieldSpec(password.FieldID, field.TypeUint))
	_spec.From = _q.sql
