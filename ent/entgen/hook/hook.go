...
type ApprovalFunc func(context.Context, *entgen.ApprovalMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f ApprovalFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.ApprovalMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.ApprovalMutation", m)
}

// The PasswordFunc type is an adapter to allow the use of ordinary
// function as Password mutator.
type PasswordFunc func(context.Context, *entgen.PasswordMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f PasswordFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.PasswordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.PasswordMutation", m)
}
...
func (f PermissionFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.PermissionMutation); ok {
		return f(ctx, mv)
	}
...
func (f RoleFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.RoleMutation); ok {
		return f(ctx, mv)
	}
...
type RolePermissionFunc func(context.Context, *entgen.RolePermissionMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f RolePermissionFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.RolePermissionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.RolePermissionMutation", m)
}
...
type UserRoleFunc func(context.Context, *entgen.UserRoleMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f UserRoleFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.UserRoleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.UserRoleMutation", m)
}
