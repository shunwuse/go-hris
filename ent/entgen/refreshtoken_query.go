...
func (_q *RefreshTokenQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RefreshTokenQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *RefreshTokenQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *RefreshTokenQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *RefreshTokenQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *RefreshTokenQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RefreshTokenQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*RefreshToken, init func(*RefreshToken), assign func(*RefreshToken, *User)) error {
