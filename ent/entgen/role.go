...
func (_m *Role) QueryUserRole() *UserRoleQuery {
	return NewRoleClient(_m.config).QueryUserRole(_m)
}

// QueryRolePermission queries the "role_permission" edge of the Role entity.
func (_m *Role) QueryRolePermission() *RolePermissionQuery {
	return NewRoleClient(_m.config).QueryRolePermission(_m)
}
